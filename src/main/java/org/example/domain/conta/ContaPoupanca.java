...
public class ContaPoupanca extends Conta {
    ...
    public ContaPoupanca(String numberAccount, String agency, Double saldo, Pessoa pessoa) throws ValorMininoAberturaDeContaPoupanca {
        super(numberAccount, agency, saldo);
        this.pessoa = pessoa;
        if (saldo < 50.0) {
            throw new ValorMininoAberturaDeContaPoupanca();
        }
    }
